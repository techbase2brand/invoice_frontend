...
const ProForm = () => {
  ...
  const handleSubmit = () => {
    ...
    if (id) {
      axios
        .put(
          `${process.env.REACT_APP_API_BASE_URL}/api/update-invoice/${id}`,
          formData,
          { headers }
        )
        .then((response) => {
                  ...
                  <>
                    ...
                    <div className="text-sm mb-4">
                      ...
                      <input
                        ...
                        className={defaultInputSmStyle}
                        onChange={(event) =>
                          setClientAddress1(event.target.value)
                        }
                      />
                    </div>
                    <div className="text-sm mb-4">
                      ...
                      <input
                        ...
                        className={defaultInputSmStyle}
                        onChange={(event) =>
                          setClientAddress2(event.target.value)
                        }
                      />
                    </div>
                    <div className="text-sm mb-4">
                            ...
                            {selectedProject?.includes(projectName) && (
                              <>
                                ...
                                <div
                                  ...
                                  onClick={() =>
                                    handleAddDescription(projectName)
                                  }
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="">
                      ...
                      <div className="text-sm mb-4">
                        <input
                          ...
                          className={defaultInputSmStyle}
                          onChange={(event) =>
                            setPayoneerId(event.target.value)
                          }
                        />
                      </div>
                    </div>
