  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: "14px" }}>
        ...
        <p>
          {" "}
          <span className="font-black">Unpaid:</span> {unpaidInvoicesLength}
        </p>
        <p>
          <span className="font-black">Draft:</span> {draftInvoicesLength}
        </p>
        <p>
          <span className="font-black"> AUD:</span> {totalAUD}
        </p>
        <p>
          {" "}
          <span className="font-black">CAD:</span> {totalCAD}
        </p>
        <p>
          {" "}
          <span className="font-black">INR:</span> {totalINR}
        </p>
        <p>
          {" "}
          <span className="font-black">USD:</span> {totalUSD}
        </p>
      </div>
      <div style={{ display: "flex", gap: "14px" }}>
        <p>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {sortedItems.map((item) => (
              <tr
                className={`bg-white border-b dark:bg-gray-800 dark:border-gray-700 ${getStatusColor(
                  item?.paymentStatus
                )}`}
                key={item._id}
              >
                    ...
                    {openItemId === item._id && (
                      <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                        <div
                          ...
                          aria-labelledby={`menuButton-${item._id}`}
                        >
                          <Link
                            to={`/project/${item._id}`}
                          ...
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="feather feather-edit w-6 h-6 mr-2"
                              fill="none"
                              height="24"
                              stroke="currentColor"
                              strokeLinecap="round"
                          ...
                          <button
                            className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 focus:outline-none"
                          ...
                          <Link
                            to={`/invoice-detail/${item._id}`}
                            className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 focus:outline-none"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="feather feather-file w-6 h-6 mr-2"
                              fill="none"
                              height="24"
                              stroke="currentColor"
                              strokeLinecap="round"
                              ...
                              width="24"
                            >
                              <path d="M15.25 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7" />
                              <path d="M15.25 2v4.75h4.75" />
                            </svg>
                            Download PDF
                          </Link>
                          <button
