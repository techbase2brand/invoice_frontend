        ...
        <div className="invoice_section_new">
          ...
          <div className="table_invoce">
            ...
            <div className="Invoice_data">
              ...
              <div className="combine_div">
                {formData.description &&
                  Object.entries(formData.description).map(
                    ([key, value], index) => {
                      const projectAmounts =
                        formData.amounts && formData.amounts[key];
                      return (
                              ...
                              <div className="task_name">
                                {value.map((val, valIndex) => (
                                  <section className="amount_task">
                                    ...
                                    {/* {priceValues[valIndex] &&
                                      priceValues[valIndex] !== "" && (
                                        <b>{priceValues[valIndex]}</b>
                                      )} */}

                                    {projectAmounts &&
                                      projectAmounts[valIndex] && (
                                        <b>{projectAmounts[valIndex]}</b>
                                      )}
                                  </section>
                                ))}
                              </div>
            ...
            <div className="sgst_per">
              {formData.sgst && (
                <p>
                  SGST ({formData.sgstper}%) : <b>{formData.sgst}</b>
                </p>
              )}
              {formData.cgst && (
                <p>
                  CGST ({formData.cgstper}%) : <b>{formData.cgst}</b>
                </p>
              )}
            </div>
